<?php
$title = 'Edit Informasi Destinasi Wisata';
        ...
        <div class="col-md-9">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Informasi Destinasi Wisata</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <?php
            foreach ($query as $data): ?>
              <form action="../../app/controller/proses-data-editdestinasiwisata" method="post" enctype="multipart/form-data">
          ...
          <div class="card">
            ...
            <div class="card-body" style="display: block;">
              <div class="row">
                ...
                <?php }else{ ?>
                  <a href="../../assets/image/foto_destinasiwisata/<?= $data['foto'] ?>" data-fancybox="gal"><img src="../../assets/image/foto_destinasiwisata/<?= $data['foto'] ?>" alt="Image" class="img-fluid"></a>
                <?php } ?>
                <p></p>
                  <div class="form-group">
                    <div class="form-group">
