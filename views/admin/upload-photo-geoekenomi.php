<?php
$title = "Upload Photo Galery Geoekonomi";
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
            <form id="myForm" action="../../app/controller/proses-upload-photo-geoekonomi.php" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="form-group">
                    <input type="text" value="<?= $_GET['id']; ?>" name="id" hidden>
                    <input type="text" value="<?= $_GET['judul']; ?>" name="judul" hidden>
