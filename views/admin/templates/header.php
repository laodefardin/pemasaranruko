...
if (!isset($_SESSION["username"])){
    echo "<script> alert('anda tidak memiliki akses untuk halaman ini!, Silahkan Login terlebih dahulu');window.location= '../../auth-signin';</script>";
...
<head>
  ...
  <title><?php echo ucfirst($title); ?> | <?= $konf['nama_perusahaan'] ?></title>
