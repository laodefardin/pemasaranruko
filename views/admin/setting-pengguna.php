    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          $foto = $data['foto'];
          if ($foto===''){?>
                <img class="profile-user-img img-fluid img-circle" src="../../assets/image/sistem/admin2.png"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <div class="row">
                          ...
                          $foto = $data['foto'];
                          if ($foto===''){?>
                            <img class="img-thumbnail" src="../../assets/image/sistem/admin2.png" alt="User profile picture">
                            <?php } else { ?>
