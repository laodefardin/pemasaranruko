         ...
         <li class="nav-item dropdown user-menu">
           ...
           <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
             ...
             <li class="user-header"
               ...
               <img src="../../assets/image/sistem/admin2.png" class="img-circle float-left" alt="User Image" style="height: 70px; width: 70px;
">
               <p>
                 <a href="./profile" style="color: #2951a3;font-weight: 700;"><?= $_SESSION['nama'] ?></a>
