...
$slug = preg_replace('/-+/', '-', $slug); // Menghapus tanda hubung berulang
                ...
                if (empty($img)){
                    $query = "UPDATE tb_destinasiwisata SET slug='$slug', judul='$judul', penulis='$penulis', isi_informasi='$isi_informasi' WHERE id = $id ";
                    ...
                    if(move_uploaded_file($tmp, $path)){
                      $query = "UPDATE tb_destinasiwisata SET slug='$slug', judul='$judul', penulis='$penulis', isi_informasi='$isi_informasi', foto='$gambar_baru' WHERE id = $id ";
